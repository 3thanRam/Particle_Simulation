...
DIM_Numb=0
dt=0
def DRAW(Tt,dt0,Lparam,DIM_Numb0,COLPTS,TRACKING,Density,LFcts,BOUNDARY_COND,ALLtimes,PARTICLE_DICT0,File_path_name=None):
    """
    ...
    None
    """
    global DIM_Numb,DO,p_var,L,Linf,dt,PARTICLE_DICT
    dt=dt0
    Linf,L=Lparam
    DIM_Numb=DIM_Numb0
    ...
    if DIM_Numb!=3:
        ...
        TRAJ_3D(dt,BOUNDARY_COND,Density,ALLtimes,TRACKING,COLPTS,LFcts,File_path_name)
